...
# %%
PIVOT_CONFIGS = [
    ("TitanicPivot", "who", "bar_clustered", "Volume by Who and Survival"),
    (
        "TitanicPivot2",
        "embark_town",
        "bar_clustered",
        "Volume by Embark Town and Survival",
    ),
    (
        "TitanicPivot3",
        "adult_male",
        "bar_clustered",
        "Volume by Adult Male and Survival",
    ),
    ("TitanicPivot4", "sex", "bar_clustered", "Volume by Sex and Survival"),
]
...
for (name, row_field, chart_type, title), dest, (left, top) in zip(
...
# %%
for name, _, _, _ in PIVOT_CONFIGS:
