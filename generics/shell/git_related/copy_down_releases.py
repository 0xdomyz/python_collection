...
clone_down_repo(
    repo_ssh=repo_ssh,
    target_parent_location=target_parent_location
)
...
def clone_down_tags(repo_ssh, repo_location, snapshots_parent_location):
    ...
    for release in releases:
        ...
        clone_down_repo(
            repo_ssh=repo_ssh, 
            target_parent_location=snapshots_parent_location
        )
        # rename
        os.rename(
...
snapshots_parent_location = r"C:\Users\yzdom\Projects\utube_playlist_mp3_downloader_snapshots"
clone_down_tags(
    repo_ssh=repo_ssh,
