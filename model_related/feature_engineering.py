...
def categorical_encoding(df: pd.DataFrame, cols: List[str],
...
def feature_selection_by_variance(X: pd.DataFrame, threshold: float = 0.01) -> List[str]:
    """
...
def correlation_filter(df: pd.DataFrame, threshold: float = 0.9,
