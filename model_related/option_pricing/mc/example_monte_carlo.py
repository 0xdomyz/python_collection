...
no_of_slice = (
    91  # no. of slices PER YEAR e.g. quarterly adjusted or 252 trading days adjusted
)

barrier_price = 80.0  # barrier level for barrier options
parisian_barrier_days = (
    21  # no.of consecutive trading days required for parisian options
)

# optional parameter
simulation_rounds = int(
    10000
)  # For monte carlo simulation, a large number of simulations required
...
MC.cox_ingersoll_ross_model(
    a=0.5, b=0.05, sigma_r=0.1
)  # use Cox Ingersoll Ross (CIR) model
